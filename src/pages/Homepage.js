    ...
    return (
        <div>
            ...
            <header className="masthead text-center text-white">
                <div className="masthead-content">
                    <div className="container">
                        ...
                        <Link className="btn btn-primary btn-xl rounded-pill mt-5" to='/login'>Continue</Link>
                    </div>
                </div>
            ...
            <footer className="py-5 bg-black">
                <div className="container">
                    <div className="text-center footer_logo"><Link to='/' href="index.html"><img src={process.env.PUBLIC_URL + 'images/homepage/footer-logo.png'} alt="" /></Link></div>
